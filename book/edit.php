                                            ...
                                            <div class="p-2">
                                                ...
                                                <div class="row">
                                                    <div class="col mb-3">
                                                        ...
                                                        <input type="text" id="title" class="form-control" name="title" placeholder="Title" value="<?= $book['title'] ?>" required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col mb-3">
                                                        ...
                                                        <input type="text" id="author" class="form-control" name="author" placeholder="Author" value="<?= $book['author'] ?>" required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col mb-3">
                                                        <label for="publisher" class="form-label">Publisher</label>
                                                        <input type="text" id="publisher" class="form-control" name="publisher" placeholder="publisher" value="<?= $book['publisher'] ?>" required>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col mb-3">
